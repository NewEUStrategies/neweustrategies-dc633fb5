-- PR #92: expert-request visibility (per-user + global toggle)
...
SELECT
  ...
  twitter_url, linkedin_url, facebook_url, instagram_url, spotify_url,
  website_url, current_company, specialization, verified_at, updated_at,
