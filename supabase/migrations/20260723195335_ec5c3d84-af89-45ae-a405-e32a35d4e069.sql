...
AS $function$
  ...
  scored AS (
    ...
    UNION ALL
    -- Firmy (member_organizations bieżącego tenantu): publiczny katalog
    -- organizacji członkowskich. Nie ujawnia crm_companies (to prywatna
    -- baza CRM), a jedynie zarejestrowane organizacje z brandingiem.
