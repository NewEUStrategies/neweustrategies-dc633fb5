-- ============================================================================
-- HUB EKSPERTA (wzorzec profili think-tank)
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_post_programs_program ON public.post_programs (program_id);
...
ALTER TABLE public.events
  ADD COLUMN IF NOT EXISTS program_id uuid REFERENCES public.programs(id) ON DELETE SET NULL;
CREATE INDEX IF NOT EXISTS idx_podcasts_program ON public.podcasts (program_id) WHERE program_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_events_program ON public.events (program_id) WHERE program_id IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_post_regions_region ON public.post_regions (region_id);
...
CREATE INDEX IF NOT EXISTS idx_post_authors_user ON public.post_authors (user_id);
...
CREATE POLICY "post_authors public read" ON public.post_authors FOR SELECT USING (true);
...
CREATE INDEX IF NOT EXISTS idx_event_speakers_user ON public.event_speakers (user_id);
...
CREATE POLICY "event_speakers public read" ON public.event_speakers FOR SELECT USING (true);
...
CREATE INDEX IF NOT EXISTS idx_expert_expertise_areas_area ON public.expert_expertise_areas (area_id);
...
CREATE POLICY "expert_areas public read" ON public.expert_expertise_areas FOR SELECT USING (true);
