...
COMMENT ON FUNCTION public.event_meeting_directory(jsonb) IS
  'Katalog uczestnikow gieldy dla zalogowanego uczestnika: {"event_slug"|"event_id", "q", "group_id", "limit", "offset"}. Kazdy wiersz przechodzi przez te sama regule, co event_meeting_invite. Zakres per widz z event_groups.attendee_visibility, wypisanie sie z event_registrations.directory_opt_out. Bez danych kontaktowych.';
