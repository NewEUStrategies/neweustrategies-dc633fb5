...
export function BillingProfileForm({
  ...
  /** Called after a successful save (e.g. checkout advancing the funnel). */
  onSaved?: () => void;
  /** Override the submit button label (checkout uses "Save and continue"). */
  submitLabel?: string;
}) {
    ...
    <TooltipProvider>
      <form className="grid gap-4 max-w-2xl" onSubmit={save}>
        <div className="flex items-center gap-2">
          ...
          />
          <Label htmlFor="is_company" title={t("profile.billing.tip.isCompany")}>
            {t("profile.billing.isCompany")}
          </Label>
        </div>

        {form.is_company ? (
          <div className="grid gap-2">
            <FieldLabel htmlFor="company" tip={t("profile.billing.tip.company")}>
              {t("profile.billing.company")}
            </FieldLabel>
            <Input
              id="company"
              value={form.company ?? ""}
          ...
          <div className="grid gap-2">
            <FieldLabel htmlFor="full_name" tip={t("profile.billing.tip.fullName")}>
              {t("profile.billing.fullName")}
            </FieldLabel>
            <Input
              id="full_name"
        ...
        {form.is_company && (
          <div className="grid gap-2">
            <FieldLabel htmlFor="tax_id" tip={t("profile.billing.tip.taxId")}>
              {t("profile.billing.taxId")}
            </FieldLabel>
            <Input
              id="tax_id"
              value={form.tax_id ?? ""}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="grid gap-2">
            <FieldLabel htmlFor="email" tip={t("profile.billing.tip.email")}>
              {t("profile.billing.email")}
            </FieldLabel>
            <Input
              id="email"
              type="email"
          ...
          <div className="grid gap-2">
            <FieldLabel htmlFor="phone" tip={t("profile.billing.tip.phone")}>
              {t("profile.billing.phone")}
            </FieldLabel>
            <Input
              id="phone"
              value={form.phone ?? ""}
        ...
        <div className="grid gap-2">
          <FieldLabel htmlFor="address_line1" tip={t("profile.billing.tip.addressLine1")}>
            {t("profile.billing.addressLine1")}
          </FieldLabel>
          <Input
            id="address_line1"
        ...
        <div className="grid gap-2">
          <FieldLabel htmlFor="address_line2" tip={t("profile.billing.tip.addressLine2")}>
            {t("profile.billing.addressLine2")}
          </FieldLabel>
          <Input
            id="address_line2"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="grid gap-2">
            <FieldLabel htmlFor="postal_code" tip={t("profile.billing.tip.postalCode")}>
              {t("profile.billing.postalCode")}
            </FieldLabel>
            <Input
              id="postal_code"
          ...
          <div className="grid gap-2">
            <FieldLabel htmlFor="city" tip={t("profile.billing.tip.city")}>
          ...
          <div className="grid gap-2">
            <FieldLabel htmlFor="region" tip={t("profile.billing.tip.region")}>
              {t("profile.billing.region")}
            </FieldLabel>
            <Input
              id="region"
              value={form.region ?? ""}
        ...
        <div className="grid gap-2">
          <FieldLabel htmlFor="country_code" tip={t("profile.billing.tip.country")}>
