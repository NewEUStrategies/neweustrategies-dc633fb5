// Zakładki zapisanych widoków HubSpot dla listy osób CRM. Łączy widoki
// wbudowane (BUILTIN_LEAD_VIEWS) i user-defined z tabeli saved_views.
...
export interface SavedLeadViewRow {
  id: string;
  name: string;
  config: unknown;
  is_shared: boolean;
      ...
      {saved.map((v) => {
        ...
        return (
          <div key={v.id} className="group relative flex items-center">
            <button
              type="button"
              onClick={() => onSelect(v.id, v.config as LeadViewConfig)}
        ...
        <PopoverContent align="start" className="w-72 space-y-3 p-3">
          <div>
            ...
            <Input
              ...
              placeholder={t("np. Hot leady EU", "e.g. Hot EU leads")}
