// Menedżer kolumn tabeli osób CRM (HubSpot "Manage columns") - lustrzany
// wobec CompanyColumnManager. Popover z listą dostępnych kolumn i toggle'ami;
// kolumna Osoba jest wymagana i nie można jej ukryć. Kolejność zachowana z
// LEAD_COLUMNS (semantyczna, bez drag&drop).
