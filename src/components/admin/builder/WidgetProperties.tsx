...
function SectionLabelEditor({
  ...
  c: WidgetNode["content"]; lang: "pl"|"en"; setContent: (k: string, v: Json) => void;
}) {
...
import { SLIDER_VARIANTS, SliderRender, type SliderVariant, type SliderItem } from "@/lib/builder/sliderVariants";
...
function AnimatedHeadingEditor({
  c, lang, setContent,
}: {
  c: WidgetNode["content"]; lang: "pl" | "en"; setContent: (k: string, v: Json) => void;
}) {
  ...
  // Color presets for the duo-tone accent
