...
export function EmptyState({ onAdd, title, hint, onLoadHomepage }: {
  onAdd: (spans: number[]) => void; title?: string; hint?: string; onLoadHomepage?: () => void;
}) {
  return (
    <div data-section-inserter className="bg-card/60 border-2 border-dashed border-brand/40 rounded-lg p-8 my-4">
      <div className="text-center mb-5">
        ...
        {onLoadHomepage && (
          <button type="button" onClick={onLoadHomepage}
