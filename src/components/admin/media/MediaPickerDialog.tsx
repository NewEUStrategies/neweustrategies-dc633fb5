...
export function MediaPickerDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex h-[min(54dvh,480px)] max-h-[calc(100dvh-env(safe-area-inset-top)-env(safe-area-inset-bottom)-32px)] w-[calc(100vw-16px)] max-w-4xl flex-col gap-3 overflow-x-hidden overflow-y-auto overscroll-contain p-4 [scrollbar-gutter:stable] sm:h-[min(52dvh,480px)] sm:max-h-[calc(100dvh-96px)] sm:w-[calc(100vw-32px)] sm:p-5">
        ...
        <div
          ...
          onDrop={onDrop}
          className={`relative shrink-0 min-h-[180px] -mx-2 px-2 pb-[max(8px,env(safe-area-inset-bottom))] rounded-md transition-colors ${
