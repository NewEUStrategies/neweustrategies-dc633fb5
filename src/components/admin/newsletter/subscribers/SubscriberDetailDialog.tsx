...
import { formatTimestamp, readConsents, readMeta } from "./subscriberDetail";
        ...
        {data && (
          <div className="space-y-5">
            ...
            <Section title="Timeline">
              <Row label="Utworzono" value={formatTimestamp(data.created_at)} />
              <Row label="Potwierdzono" value={formatTimestamp(data.confirmed_at)} />
              <Row label="Wypisano" value={formatTimestamp(data.unsubscribed_at)} />
              <Row label="Aktualizacja" value={formatTimestamp(data.updated_at)} />
            </Section>
