...
function getTone(status: string): {
  ...
  switch (status) {
    case "published":
      return {
        classes: "border-emerald-500/40 bg-emerald-500/15 text-emerald-700 dark:text-emerald-400",
        icon: Check,
      };
    case "draft":
      return {
    ...
    case "pending_review":
      return {
        classes: "border-sky-500/40 bg-sky-500/15 text-sky-700 dark:text-sky-400",
        icon: Send,
      };
    case "scheduled":
      return {
        classes: "border-violet-500/40 bg-violet-500/15 text-violet-700 dark:text-violet-400",
        icon: Clock,
      };
    case "archived":
      return {
        classes: "border-slate-500/40 bg-slate-500/15 text-slate-700 dark:text-slate-300",
        icon: Lock,
      };
    default:
      return {
