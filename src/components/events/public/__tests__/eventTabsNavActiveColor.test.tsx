...
//      (`text-[color:…]` bez wariantu). Ta asercja jest ODPORNA NA KOLEJNOŚĆ
...
// selektorem `[class~="…"]`, żeby nie escapować nawiasów. Wiązanie jest częścią
...
describe("pasek zakladek wydarzenia: bierzaca pozycja ma kolor bierzacej", () => {
  ...
  it("pasek BEZ koloru nawigacji bierze tokeny motywu - odwrot dziala dalej", async () => {
    // Kazda wartosc `var(--event-nav-*, …)` ma drugi argument. Rozdzielenie klas
