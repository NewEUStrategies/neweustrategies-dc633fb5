// GNIAZDO `ManageFollowUpSlot` - test zaślepki Foundation (WŁAŚCICIEL: tor C).
//
...
describe("ManageFollowUpSlot - zaślepka Foundation", () => {
    ...
    const { container } = render(
      <ManageFollowUpSlot
        {...{
          slug: PARTICIPANT_EVENT_SLUG,
          token: null,
          view: makeRegistrationManageView({ status: "attended" }),
        }}
      />,
    );
