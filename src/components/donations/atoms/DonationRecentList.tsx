...
import { fmtMoney, fmtRelative, type RecentDonation } from "../donationsWidgetModel";
...
export function DonationRecentList({ recent, currency, lang }: DonationRecentListProps) {
