...
// sekcji (`cfpReviewers`) i etykieta (`adminEvents.studio.sections.cfpReviewers`) są
...
function EventStudioCfpReviewersPage() {
  ...
  return (
    <EventStudioPage title={t("adminEvents.studio.sections.cfpReviewers")}>{null}</EventStudioPage>
  );
}
