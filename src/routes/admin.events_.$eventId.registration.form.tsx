// /admin/events/<id>/registration/form - podstrona „Registration form" studia wydarzenia.
//
...
import { EventRegistrationFormSection } from "@/components/admin/events/studio/EventStudioModuleSections";
import { useAdminEventDetail } from "@/lib/events/useAdminEventDetail";

export const Route = createFileRoute("/admin/events_/$eventId/registration/form")({
  head: () => ({
    meta: [
      { title: "Registration form · Event · Admin" },
      { name: "robots", content: "noindex, nofollow" },
      {
        name: "description",
        content: "Fields and questions of the registration form of this event.",
      },
    ],
  }),
  component: EventStudioRegistrationFormPage,
});

function EventStudioRegistrationFormPage() {
  ...
  return <EventRegistrationFormSection row={row} />;
}
