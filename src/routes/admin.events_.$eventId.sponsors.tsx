// /admin/events/<id>/sponsors - sekcja „Sponsors" studia wydarzenia.
//
...
import { EventSponsorsSection } from "@/components/admin/events/studio/EventStudioModuleSections";
import { useAdminEventDetail } from "@/lib/events/useAdminEventDetail";

export const Route = createFileRoute("/admin/events_/$eventId/sponsors")({
  head: () => ({
    meta: [
      { title: "Sponsors · Event · Admin" },
      { name: "robots", content: "noindex, nofollow" },
      {
        name: "description",
        content: "Sponsor tiers and the sponsor list shown on this event's pages.",
      },
    ],
  }),
  component: EventStudioSponsorsPage,
});

function EventStudioSponsorsPage() {
  ...
  return <EventSponsorsSection row={row} />;
}
