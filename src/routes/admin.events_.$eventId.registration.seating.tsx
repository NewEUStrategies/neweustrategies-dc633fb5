...
// sekcji (`registrationSeating`) i etykieta (`adminEvents.studio.sections.registrationSeating`) są
...
// f4 (plan sali) - zastępuje CIAŁO komponentu swoim organizmem, zostawiając
...
function EventStudioRegistrationSeatingPage() {
  ...
  return (
    <EventStudioPage title={t("adminEvents.studio.sections.registrationSeating")}>
      {null}
    </EventStudioPage>
  );
}
