// /admin/events/<id>/branding - sekcja „Branding" studia wydarzenia.
//
...
import { EventBrandingPanel } from "@/components/admin/events/organisms/EventBrandingPanel";
import { useAdminEventDetail } from "@/lib/events/useAdminEventDetail";

export const Route = createFileRoute("/admin/events_/$eventId/branding")({
  head: () => ({
    meta: [
      { title: "Branding · Event · Admin" },
      { name: "robots", content: "noindex, nofollow" },
      {
        name: "description",
        content: "Colours, typography and logo of this event's public pages.",
      },
    ],
  }),
  component: EventStudioBrandingPage,
});

function EventStudioBrandingPage() {
  ...
  return <EventBrandingPanel row={row} />;
}
