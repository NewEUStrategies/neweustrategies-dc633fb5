// /admin/events/terms - WYCOFANE, przekierowanie na liste wydarzen.
//
...
//
// GDZIE TO JEST TERAZ: studio wydarzenia, grupa „Kreator wydarzenia",
// sekcje groups (grupy i czlonkowie) oraz terms (zgody).
