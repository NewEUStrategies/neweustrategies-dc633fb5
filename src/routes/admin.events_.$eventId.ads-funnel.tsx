...
// sekcji (`adsFunnel`) i etykieta (`adminEvents.studio.sections.adsFunnel`) są
...
// f3 (lejek Google Ads) - zastępuje CIAŁO komponentu swoim organizmem, zostawiając
...
function EventStudioAdsFunnelPage() {
  ...
  return (
    <EventStudioPage title={t("adminEvents.studio.sections.adsFunnel")}>{null}</EventStudioPage>
  );
}
