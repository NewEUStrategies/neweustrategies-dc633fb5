...
//
// CIAŁO EKRANU TO ORGANIZM `CfpFormPanel` (agent f1, nabór prelegentów). Trasa,
// pozycja w sidebarze (`EVENT_STUDIO_NAV`), klucz sekcji (`cfpForm`) i tytuł
// (`adminEvents.studio.sections.cfpForm`) pochodzą z fundamentu i się nie zmieniają.
//
...
import { CfpFormPanel } from "@/components/admin/events/organisms/CfpFormPanel";
...
function EventStudioCfpFormPage() {
  ...
  return (
    <EventStudioPage title={t("adminEvents.studio.sections.cfpForm")}>
      <CfpFormPanel eventId={eventId} />
    </EventStudioPage>
  );
}
