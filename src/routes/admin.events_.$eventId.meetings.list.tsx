// /admin/events/<id>/meetings/list - podstrona „Meetings" studia wydarzenia.
//
...
import { EventMeetingsListSection } from "@/components/admin/events/studio/EventStudioModuleSections";
import { useAdminEventDetail } from "@/lib/events/useAdminEventDetail";

export const Route = createFileRoute("/admin/events_/$eventId/meetings/list")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "One-to-one meetings arranged at this event.",
      },
    ],
  }),
  component: EventStudioMeetingsListPage,
});

function EventStudioMeetingsListPage() {
  ...
  return <EventMeetingsListSection row={row} />;
}
