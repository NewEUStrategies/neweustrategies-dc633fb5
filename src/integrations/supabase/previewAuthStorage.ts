...
export function brokeredPreviewStorage() {
  ...
  const request = (
    ...
    new Promise((resolve) => {
      ...
      // `const` po postMessage, a nie `let` na gorze: `finish` (i jedyne
      // `clearTimeout`) odpalaja sie WYLACZNIE asynchronicznie - `postMessage`
      // dostarcza zdarzenie w kolejnym zadaniu, wiec domkniecie nie ma jak
      // dotknac `timer` przed tym przypisaniem.
