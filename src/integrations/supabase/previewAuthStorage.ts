...
export function brokeredPreviewStorage() {
  ...
  const request = (
    ...
    new Promise((resolve) => {
      ...
      // `const` mimo ze `finish` (wyzej) czyta `timer`: zdarzenia `message` sa
      // dostarczane WYLACZNIE asynchronicznie, wiec `finish` nie ma jak wystartowac
      // przed koncem tego bloku - odczyt zawsze trafia na przypisana wartosc.
