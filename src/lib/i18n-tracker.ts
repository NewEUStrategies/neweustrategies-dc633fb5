...
export const trackerPl = {
  tracker: {
    ...
    monitorProOnly: "Monitoring regulacyjny z alertami jest częścią planu Pro.",
    monitorSeePlans: "Zobacz plan Pro",
...
export const trackerEn = {
  tracker: {
    ...
    monitorProOnly: "Regulatory monitoring with alerts is part of the Pro plan.",
    monitorSeePlans: "See the Pro plan",
    reference: "Reference",
    source: "Source",
    timeline: "Timeline",
