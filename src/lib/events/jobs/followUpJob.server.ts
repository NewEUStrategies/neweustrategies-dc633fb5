// Zadanie w tle: ankieta i certyfikat po wydarzeniu (F5).
//
// ZAŚLEPKA FOUNDATION. Harmonogram (`jobsTick.server.ts`, `community-cron.ts`)
// woła tę funkcję od pierwszego dnia, żeby tor C wymieniał wyłącznie treść
...
export async function runEventFollowUp(
