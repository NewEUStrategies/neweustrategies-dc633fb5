...
export const FOOTER_LINKS: readonly FooterLink[] = [
  ...
  { group: "editorial", href: "/category/policy-papers", label: { pl: "Policy papers", en: "Policy papers" } },
  { group: "editorial", href: "/podcasts", label: { pl: "Podcast", en: "Podcast" } },
  // Topics
  { group: "topics", href: "/category/geopolityka", label: { pl: "Geopolityka", en: "Geopolitics" } },
  { group: "topics", href: "/category/bezpieczenstwo", label: { pl: "Bezpieczeństwo", en: "Security" } },
  ...
  { group: "community", href: "/spotkania-chatham-house", label: { pl: "Spotkania Chatham House", en: "Chatham House meetings" } },
  { group: "community", href: "/dolacz-do-newslettera", label: { pl: "Newsletter", en: "Newsletter" } },
