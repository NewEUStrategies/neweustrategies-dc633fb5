...
export const WIDGET_REGISTRY: WidgetLibraryItem[] = [
  ...
  },
  {
    ...
    labelPl: "Pole tekstowe (inne)",
    labelEn: "Text field (other)",
    group: "fields",
  },
  {
    type: "field.select",
    icon: "ListFilter",
    labelPl: "Lista wyboru",
    labelEn: "Select",
    group: "fields",
  },
  {
    ...
    icon: "Layers",
    labelPl: "Listy mailingowe",
    labelEn: "Mailing lists",
    group: "fields",
  },
  {
    type: "field.checkbox",
    icon: "SquareCheck",
    labelPl: "Checkbox / zgoda",
    labelEn: "Checkbox / consent",
    group: "fields",
  },
  {
    type: "submit",
    icon: "Send",
    labelPl: "Przycisk zapisu",
  ...
  },
  {
    type: "close-button",
    icon: "X",
    labelPl: "Przycisk zamknij",
    labelEn: "Close button",
    group: "action",
    contexts: ["popup"],
  },
];
