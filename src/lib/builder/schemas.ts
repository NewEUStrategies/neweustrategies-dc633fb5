...
export const WIDGET_SCHEMAS: Partial<Record<WidgetType, ReadonlyArray<SchemaField>>> = {
  ...
  "club-hub": [
    ...
    { key: "articlesLimit", type: "number", label: "Liczba artykułów", min: 1, max: 12, group: "Dane" },
    { key: "commentsLimit", type: "number", label: "Liczba komentarzy", min: 1, max: 12, group: "Dane" },
    { key: "signupsLimit", type: "number", label: "Liczba zapisów", min: 1, max: 12, group: "Dane" },
