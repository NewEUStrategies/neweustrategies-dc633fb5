...
export const WIDGETS: WidgetDef[] = [
  ...
  { type: "contact", label: "Formularz kontaktowy (legacy)", category: "form", icon: Send, hiddenInPalette: true,
    defaults: () => ({
      ...
      requireConsent: true, showFirstName: true, showLastName: true, showEmail: true, showMessage: true,
      consentText_pl: "Wyrażam zgodę na przetwarzanie moich danych osobowych zgodnie z [Polityką prywatności](/polityka-prywatnosci).",
      consentText_en: "I consent to processing of my personal data in accordance with the [Privacy Policy](/privacy-policy).",
