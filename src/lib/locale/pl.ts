...
export const pl = {
  ...
  quiz: {
    share: {
      ...
      expand: "Rozwiń panel udostępniania",
      collapse: "Zwiń panel udostępniania",
      linkedin: "LinkedIn",
      facebook: "Facebook",
      messenger: "Messenger",
      whatsapp: "WhatsApp",
  ...
  admin: {
    ...
    icons: {
      ...
      fields: {
        ...
        label: "Etykieta",
        labelPh: "np. Logo New European Strategies",
    ...
    paywall: {
      ...
      meteringTitle: "Metering - darmowy limit miesięczny",
      meteringSubtitle:
        "Lejek konwersji: anonim → rejestracja (limit konta bezpłatnego) → subskrypcja. Egzekwowanie jest serwerowe; per wpis/stronę nadpiszesz udział w edytorze (sekcja Dostęp / Paywall).",
      meteringEnabled: "Metering włączony",
      meteringMemberLimit: "Limit dla zalogowanych (artykuły / mies.)",
      meteringAnonLimit: "Limit dla anonimów (0 = wymagaj rejestracji)",
      meteringMeterPaid: "Licz artykuły płatne",
      ...
      overridesEmpty: "Brak wyjątków - wszystkie treści dziedziczą ustawienia globalne.",
      overridesColEntity: "Treść",
      overridesColMode: "Tryb",
      overridesColPolicy: "Polityka",
      overridePolicyInherit: "Dziedzicz",
      overridePolicyMetered: "Zawsze licz",
      overridePolicyExempt: "Wyłącz z limitu",
      overrideSaved: "Zapisano politykę",
      entityPost: "Wpis",
      entityPage: "Strona",
      checkoutTitle: "Checkout - kupony, podatki, faktury",
      checkoutSubtitle:
        "Ustawienia sesji płatności Stripe. Kupony i kody promocyjne tworzysz w panelu Stripe (Produkty → Kupony); okres próbny ustawiasz per plan powyżej.",
      allowPromo: "Pole „kod promocyjny” w Stripe Checkout",
      ...
      addressAuto: "Automatycznie (gdy wymagany)",
  ...
  blocks: {
    ...
    settings: {
      ...
      sepDots: "Kropki",
      colorPalette: "Kolorystyka",
      quoteVariant: {
        default: "Z linią (border)",
        plain: "Plain (z ikoną)",
        card: "Karta",
        minimal: "Minimalny",
      },
  ...
  notifications: {
    ...
    settings: {
      ...
      kinds: {
        ...
        introduction: "Wprowadzenia przez wspólne kontakty",
        meeting: "Rezerwacje spotkań 1-1",
        recommendation: "Rekomendacje na profilu",
        endorsement: "Potwierdzenia umiejętności",
        profile_view: "Odsłony profilu (podsumowanie dobowe)",
