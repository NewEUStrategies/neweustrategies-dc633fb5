...
export const adminEventRegistrationPl = {
  adminEventRegistration: {
    ...
    tickets: {
      ...
      studio: {
        langTabs: "Język treści biletu",
        tabPl: "Polski",
        tabEn: "Angielski",
        basics: "Podstawy",
        basicsHint:
          "Bilet jest dostępny w podanym oknie sprzedaży. Bilet ukryty działa tylko z bezpośredniego linku rejestracyjnego.",
        content: "Treść biletu",
        contentHint: "Nazwa, opis, korzyści i etykieta w wybranym języku.",
        name: "Nazwa biletu",
        description: "Opis (opcjonalnie)",
        benefits: "Korzyści - jedna w linii",
        charCount: "{{count}}/{{max}} znaków",
        type: "Rodzaj biletu",
        typeHint: "Bilet bezpłatny albo płatny. Przy bezpłatnym możesz ustawić własną etykietę.",
        free: "Bezpłatny",
        paid: "Płatny",
        showLabel: "Pokaż etykietę",
        showLabelHint:
          "Włączona - uczestnik widzi etykietę ceny. Wyłączona - cena na karcie biletu jest ukryta.",
        label: "Etykieta",
        visibility: "Widoczność biletu",
        visible: "Widoczny",
        hidden: "Ukryty",
        hiddenHint: "Bilet ukryty nie pojawia się na liście - dostęp daje link rejestracyjny.",
        payment: "Szczegóły płatności",
        paymentHint:
          "Cena, waluta i cennik w czasie. Płatność obsługuje bramka płatności wydarzenia.",
        other: "Pozostałe ustawienia",
        otherHint:
          "Grupa, do której trafia uczestnik z tym biletem. Grupy sterują uprawnieniami i komunikacją.",
        groupPlaceholder: "Wybierz grupę",
        moderated: "Rejestracja moderowana",
        moderatedHint:
        ...
        registrationUrlHint:
          "Udostępnij link osobom rejestrującym się; w razie potrzeby dodaj kod.",
        ticketId: "ID biletu",
        copy: "Kopiuj",
        copied: "Skopiowano do schowka",
        copyFailed: "Nie udało się skopiować",
        duplicate: "Duplikuj",
        duplicateSuffixPl: " (kopia)",
        duplicateSuffixEn: " (copy)",
        duplicated: "Utworzono kopię biletu",
        search: "Szukaj biletu",
        noResults: "Brak biletów pasujących do wyszukiwania.",
        moreActions: "Więcej akcji",
        edit: "Edytuj",
        copyUrl: "Kopiuj link rejestracyjny",
        delete: "Usuń",
        usesUnlimited: "{{sold}}/bez limitu",
        usesLimited: "{{sold}}/{{quota}}",
        noDate: "-",
        status: {
          on_sale: "W sprzedaży",
...
export const adminEventRegistrationEn = {
  adminEventRegistration: {
    ...
    tickets: {
      ...
      studio: {
        langTabs: "Ticket content language",
        tabPl: "Polish",
        tabEn: "English",
        basics: "Basics",
        basicsHint:
          "The ticket is available within the sales window. A hidden ticket works only through its direct registration link.",
        content: "Ticket content",
        contentHint: "Name, description, benefits and label in the selected language.",
        name: "Ticket name",
        ...
        type: "Ticket type",
        typeHint:
          "Choose whether the ticket is free or paid. A free ticket can have a custom label.",
        free: "Free",
        paid: "Paid",
        showLabel: "Show label",
        showLabelHint:
          "When enabled, registrants see the price label. When disabled, the price on the ticket card is hidden.",
        label: "Label",
        visibility: "Ticket visibility",
        visible: "Visible",
        hidden: "Hidden",
        hiddenHint:
          "A hidden ticket is not listed - it is reachable through its registration link.",
        payment: "Payment details",
        paymentHint:
          "Price, currency and time-based pricing. Payments go through the event payment gateway.",
        other: "Other settings",
        otherHint:
          "The group attendees with this ticket join. Groups manage permissions and communications.",
        ...
        duplicateSuffixPl: " (kopia)",
        duplicateSuffixEn: " (copy)",
        duplicated: "Ticket duplicated",
        search: "Search tickets",
        noResults: "No tickets match your search.",
        moreActions: "More actions",
        edit: "Edit",
        copyUrl: "Copy registration URL",
        delete: "Delete",
        usesUnlimited: "{{sold}}/Unlimited",
        usesLimited: "{{sold}}/{{quota}}",
        noDate: "-",
        status: {
          on_sale: "On sale",
