...
const pl = {
  ...
  inlineEntity: {
    companyCard: "Karta firmy: {{name}}",
    personCard: "Karta osoby: {{name}}",
    ...
    socialLink: "{{network}} - {{name}} (otwiera się w nowej karcie)",
    close: "Zamknij kartę",
    networks: {
      linkedin: "LinkedIn",
      x: "X",
...
const en: typeof pl = {
  ...
  inlineEntity: {
    companyCard: "Company card: {{name}}",
    personCard: "Person card: {{name}}",
    ...
    socialLink: "{{network}} - {{name}} (opens in a new tab)",
    close: "Close card",
    networks: {
      linkedin: "LinkedIn",
      x: "X",
