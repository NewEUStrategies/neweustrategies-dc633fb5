...
import { MAX_TEAM_SEATS, MIN_TEAM_SEATS, type SeatsSource } from "@/lib/organizations/teamSeats";
...
function readReconcile(value: unknown): { seatsLimit: number; active: number; suspended: number } {
