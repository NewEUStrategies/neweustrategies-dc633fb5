...
export const eventMeetingsPl = {
  eventMeetings: {
    ...
    errors: {
      ...
      same_person: "Nie umówisz spotkania z samym sobą.",
      slot_invalid: "Ten termin nie mieści się w siatce giełdy - wybierz z listy.",
      slot_outside_availability: "Ten termin wypada poza Twoim oknem dostępności.",
      counterpart_unavailable: "Rozmówca nie ma otwartego okna w tym terminie.",
      group_not_allowed: "Reguły tego wydarzenia nie pozwalają na spotkanie tych dwóch grup.",
      ...
      availability_in_use: "W tym oknie jest zaplanowane spotkanie - najpierw je odwołaj.",
