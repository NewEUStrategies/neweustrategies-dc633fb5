...
const adminPricingPl = {
  adminPricing: {
    ...
    benefits: {
      ...
      moveDown: "Przesuń niżej",
      remove: "Usuń",
      preview: "Podgląd benefitu",
      previewTitle: "Podgląd benefitu w cenniku",
      previewHint: "Tak ten punkt zobaczy klient na karcie warstwy - w obu językach.",
      previewPl: "Wersja polska",
      previewEn: "Wersja angielska",
...
const adminPricingEn: typeof adminPricingPl = {
  adminPricing: {
    ...
    benefits: {
      ...
      moveDown: "Move down",
      remove: "Remove",
      preview: "Preview benefit",
      previewTitle: "Benefit preview on the pricing card",
      previewHint: "This is how a customer sees the item on the tier card - in both languages.",
      previewPl: "Polish version",
      previewEn: "English version",
      more: "Detail & group",
      detailPl: "Rozwinięcie PL (styl NYT)",
      detailEn: "Detail EN (NYT style)",
      groupPl: "Nagłówek grupy PL (styl FT)",
