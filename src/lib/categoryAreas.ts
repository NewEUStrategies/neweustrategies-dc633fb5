...
export const CORE_CATEGORY_AREAS: readonly CoreCategoryArea[] = [
  ...
  { slug: "cyberbezpieczenstwo",     name_pl: "Cyberbezpieczeństwo",     name_en: "Cybersecurity",           color: "#7c3aed" },
  ...
  { slug: "stosunki-miedzynarodowe", name_pl: "Stosunki międzynarodowe", name_en: "International Relations", color: "#475569" },
