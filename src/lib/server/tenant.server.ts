 ...
 * hosta marki albo domeny faktycznie zajętej w katalogu. Fallback z
 * `resolveCrawlerTenantForHost` byłby tu luką - podgląd i pusty katalog
 * mapują na tenanta domyślnego, a to nie czyni obcej domeny kanoniczną.
 */
