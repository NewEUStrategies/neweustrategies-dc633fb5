...
const pl = {
  adsAdmin: {
    ...
    slots: {
      ...
      empty: "Brak slotów. Dodaj pierwszy poniżej.",
      addTitle: "Nowy slot",
      ...
      fieldKind: "Typ",
      fieldHtml: "Kod HTML",
      fieldScript: "Skrypt (np. AdSense)",
      fieldImageUrl: "URL grafiki",
      fieldClickUrl: "Link kliknięcia",
      fieldAlt: "Alt (dla dostępności)",
      fieldWidth: "Szerokość (px)",
      fieldHeight: "Wysokość (px)",
      fieldActive: "Aktywny",
      fieldRequiresConsent: "Wymaga zgody marketingowej (RODO)",
    ...
    stats: {
      ...
      clicks: "Kliknięcia",
      empty: "Brak danych.",
      // Znak braku danych w kolumnie CTR - dywiz ASCII, nie pauza (U+2014):
      // raport bywa kopiowany do arkusza reklamodawcy, gdzie pauza w kodowaniu
      // jednobajtowym rozsypuje się na „â€”".
      noData: "-",
      loading: "Wczytywanie...",
    },
...
const en: typeof pl = {
  adsAdmin: {
    ...
    slots: {
      ...
      empty: "No slots yet. Add the first one below.",
      addTitle: "New slot",
      editTitle: "Edit slot",
      addAction: "Add slot",
      fieldName: "Name",
      fieldKind: "Type",
      fieldHtml: "HTML code",
      fieldScript: "Script (e.g. AdSense)",
      ...
      fieldActive: "Active",
      fieldRequiresConsent: "Requires marketing consent (GDPR)",
      fieldNotes: "Internal notes",
      sandboxHtmlHint:
        "The creative runs in a sandboxed frame - with no access to the reader session or the page DOM.",
      sandboxScriptHint:
        "The script runs in a sandboxed frame - with no access to the reader session or the page DOM.",
      nameRequired: "Name is required",
      deleteTitle: "Delete the slot?",
      deleteBody: "All related placements will disappear as well.",
      deleteAction: "Delete slot",
    },
