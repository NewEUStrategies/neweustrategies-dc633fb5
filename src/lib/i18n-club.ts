...
export const clubPl = {
  club: {
    ...
    post: {
      ...
      addMedia: "Dodaj plik",
      mediaHint: "Zdjęcia, PDF, wideo do 50 MB",
    ...
    workspace: {
      ...
      panel: {
        discussion: "Dyskusja", participants: "Skład", documents: "Źródła",
        schedule: "Harmonogram", questions: "Pytania", polls: "Głosowania",
        links: "Powiązania", insights: "Dane", search: "Szukaj",
      },
      section: { reply: "Wypowiedzi", document: "Źródła", milestone: "Harmonogram", question: "Pytania" },
      documentKind: { document: "Dokument", dataset: "Zbiór danych", link: "Odnośnik", note: "Notatka", recording: "Nagranie" },
      milestoneKind: { milestone: "Etap", meeting: "Spotkanie", deadline: "Termin", publication: "Publikacja", vote: "Głosowanie", consultation: "Konsultacje" },
      milestoneStatus: { planned: "Zaplanowany", active: "W toku", done: "Zamknięty", cancelled: "Odwołany" },
      questionStatus: { open: "Otwarte", answered: "Odpowiedziane", declined: "Odrzucone", hidden: "Ukryte" },
      questionSort: { top: "Najczęściej podnoszone", newest: "Najnowsze", unanswered: "Bez odpowiedzi" },
      linkDirection: { incoming: "Powiązanie przychodzące", outgoing: "Powiązanie wychodzące" },
      relation: {
        outgoing: { continues: "Kontynuuje", supersedes: "Zastępuje", contradicts: "Polemizuje z", supports: "Wspiera", duplicates: "Powiela", context: "Kontekst" },
        incoming: { continues: "Kontynuowany przez", supersedes: "Zastąpiony przez", contradicts: "Zakwestionowany przez", supports: "Wsparty przez", duplicates: "Powielony przez", context: "Kontekst dla" },
      },
      save: "Zapisz", cancel: "Anuluj", remove: "Usuń", openLink: "Otwórz źródło",
      error: {
      ...
      documents: {
        add: "Dodaj źródło", addFirst: "Dodaj pierwsze źródło", addedBy: "dodał(a): {{name}}",
        allKinds: "Wszystkie rodzaje", filterLabel: "Rodzaj źródła", kindLabel: "Rodzaj",
        titleLabel: "Tytuł", urlLabel: "Adres", descriptionLabel: "Opis",
        sourceLabel: "Źródło", sourcePlaceholder: "np. Komisja Europejska",
        publishedLabel: "Data publikacji", publishedHint: "Data dokumentu, nie data dodania.",
        primary: "Źródło główne", primaryLabel: "Oznacz jako źródło główne",
        ...
        saved: "Zapisano źródło.", removed: "Usunięto źródło.",
        removeConfirm: "Usunąć to źródło z wątku?",
      },
      schedule: {
        add: "Dodaj pozycję", addFirst: "Ułóż pierwszą pozycję",
        titleLabel: "Tytuł", kindLabel: "Rodzaj", statusLabel: "Status",
        startsLabel: "Początek", endsLabel: "Koniec", allDay: "Cały dzień",
        locationLabel: "Miejsce", urlLabel: "Adres", descriptionLabel: "Opis",
        rangeError: "Koniec nie może być wcześniejszy niż początek.",
        owner: "prowadzi: {{name}}", openEvent: "Zobacz wydarzenie",
        ...
        saved: "Zapisano pozycję.", removed: "Usunięto pozycję.",
        removeConfirm: "Usunąć tę pozycję harmonogramu?",
      },
      calendar: { caption: "Kalendarz wątku", previous: "Poprzedni miesiąc", next: "Następny miesiąc", more: "+{{count}} więcej" },
      questions: {
        ask: "Zadaj pytanie", askLabel: "Twoje pytanie", askPlaceholder: "O co chcesz zapytać prowadzenie?",
        asked: "Pytanie zostało wysłane.", answer: "Odpowiedź", answerCta: "Odpowiedz",
        answerLabel: "Treść odpowiedzi", publishAnswer: "Opublikuj odpowiedź", editAnswer: "Edytuj odpowiedź",
        answerSaved: "Zapisano odpowiedź.", answeredBy: "odpowiada: {{name}}",
        vote: "Podbij pytanie", sortLabel: "Kolejność pytań",
        openCount_one: "{{count}} pytanie bez odpowiedzi", openCount_few: "{{count}} pytania bez odpowiedzi",
        openCount_many: "{{count}} pytań bez odpowiedzi", openCount_other: "{{count}} pytań bez odpowiedzi",
      ...
      polls: {
        create: "Nowe głosowanie", created: "Głosowanie zostało otwarte.",
        questionPl: "Pytanie (PL)", questionEn: "Pytanie (EN)", optionsLabel: "Warianty odpowiedzi",
        optionAria: "Wariant {{index}}", addOption: "Dodaj wariant", removeOption: "Usuń wariant",
        open: "Otwarte", closed: "Zamknięte",
        detach: "Odepnij głosowanie", detached: "Głosowanie zostało odpięte.",
      ...
      links: {
        ...
        removed: "Usunięto powiązanie.", removeConfirm: "Usunąć to powiązanie?",
      },
      participants: {
        author: "Autor wątku", distribution: "Rozkład wkładu", lastActive: "ostatnio: {{value}}",
        replies_one: "{{count}} wypowiedź", replies_few: "{{count}} wypowiedzi", replies_many: "{{count}} wypowiedzi", replies_other: "{{count}} wypowiedzi",
        questions_one: "{{count}} pytanie", questions_few: "{{count}} pytania", questions_many: "{{count}} pytań", questions_other: "{{count}} pytań",
        documents_one: "{{count}} źródło", documents_few: "{{count}} źródła", documents_many: "{{count}} źródeł", documents_other: "{{count}} źródeł",
        reactions_one: "{{count}} reakcja", reactions_few: "{{count}} reakcje", reactions_many: "{{count}} reakcji", reactions_other: "{{count}} reakcji",
        empty: "Nikt jeszcze nie zabrał głosu.",
        emptyHint: "Skład pojawi się po pierwszej wypowiedzi.",
      },
      insights: {
        timeline: "Rytm wątku", period: "Okres: {{value}}", chartAria: "Wykres aktywności wątku",
        tableCaption: "Aktywność wątku w kolejnych odcinkach czasu",
        series: { replies: "Wypowiedzi", questions: "Pytania", documents: "Źródła", milestones: "Etapy" },
        empty: "Nie ma jeszcze danych.", emptyHint: "Wykres pojawi się po pierwszej aktywności.",
      },
      search: {
        label: "Szukaj w wątku", placeholder: "Szukaj w wypowiedziach, źródłach i pytaniach...",
        hint: "Przeszukujemy cały wątek, nie tylko widoczną stronę.",
        idle: "Wpisz frazę", idleHint: "Wyniki obejmą wypowiedzi, źródła, harmonogram i pytania.",
        tooShort: "Wpisz co najmniej dwa znaki.",
        noResults: "Brak wyników", noResultsHint: "Spróbuj innej frazy albo krótszego słowa.",
        resultsCount_one: "{{count}} wynik", resultsCount_few: "{{count}} wyniki",
        resultsCount_many: "{{count}} wyników", resultsCount_other: "{{count}} wyników",
      },
      tabs: {
        threads: "Wątki",
        documents: "Dokumenty",
...
export const clubEn = {
  club: {
    ...
    post: {
      ...
      addMedia: "Add file",
      mediaHint: "Images, PDF, video up to 50 MB",
    ...
    workspace: {
      ...
      panel: {
        discussion: "Discussion", participants: "People", documents: "Sources",
        schedule: "Schedule", questions: "Questions", polls: "Votes",
        links: "Related", insights: "Activity", search: "Search",
      },
      section: { reply: "Replies", document: "Sources", milestone: "Schedule", question: "Questions" },
      documentKind: { document: "Document", dataset: "Dataset", link: "Link", note: "Note", recording: "Recording" },
      milestoneKind: { milestone: "Milestone", meeting: "Meeting", deadline: "Deadline", publication: "Publication", vote: "Vote", consultation: "Consultation" },
      milestoneStatus: { planned: "Planned", active: "In progress", done: "Closed", cancelled: "Cancelled" },
      questionStatus: { open: "Open", answered: "Answered", declined: "Declined", hidden: "Hidden" },
      ...
      relation: {
        outgoing: { continues: "Continues", supersedes: "Supersedes", contradicts: "Contradicts", supports: "Supports", duplicates: "Duplicates", context: "Context" },
        incoming: { continues: "Continued by", supersedes: "Superseded by", contradicts: "Contradicted by", supports: "Supported by", duplicates: "Duplicated by", context: "Context for" },
      },
      save: "Save", cancel: "Cancel", remove: "Remove", openLink: "Open source",
      error: {
      ...
      documents: {
        add: "Add source", addFirst: "Add the first source", addedBy: "added by {{name}}",
        allKinds: "All kinds", filterLabel: "Source kind", kindLabel: "Kind",
        titleLabel: "Title", urlLabel: "URL", descriptionLabel: "Description",
        sourceLabel: "Publisher", sourcePlaceholder: "e.g. European Commission",
        publishedLabel: "Publication date", publishedHint: "Date of the document, not of adding it.",
        primary: "Primary source", primaryLabel: "Mark as primary source",
        ...
        saved: "Source saved.", removed: "Source removed.",
        removeConfirm: "Remove this source from the thread?",
      },
      schedule: {
        add: "Add entry", addFirst: "Add the first entry",
        titleLabel: "Title", kindLabel: "Kind", statusLabel: "Status",
        startsLabel: "Starts", endsLabel: "Ends", allDay: "All day",
        locationLabel: "Location", urlLabel: "URL", descriptionLabel: "Description",
        rangeError: "The end cannot be earlier than the start.",
        owner: "owner: {{name}}", openEvent: "Open event",
        ...
        saved: "Entry saved.", removed: "Entry removed.",
        removeConfirm: "Remove this schedule entry?",
      },
      calendar: { caption: "Thread calendar", previous: "Previous month", next: "Next month", more: "+{{count}} more" },
      questions: {
        ask: "Ask a question", askLabel: "Your question", askPlaceholder: "What do you want to ask the moderators?",
        asked: "Question sent.", answer: "Answer", answerCta: "Answer",
        answerLabel: "Answer text", publishAnswer: "Publish answer", editAnswer: "Edit answer",
        answerSaved: "Answer saved.", answeredBy: "answered by {{name}}",
        vote: "Upvote question", sortLabel: "Question order",
        openCount_one: "{{count}} unanswered question", openCount_other: "{{count}} unanswered questions",
      ...
      polls: {
        create: "New vote", created: "The vote is open.",
        questionPl: "Question (PL)", questionEn: "Question (EN)", optionsLabel: "Options",
        optionAria: "Option {{index}}", addOption: "Add option", removeOption: "Remove option",
        open: "Open", closed: "Closed",
        detach: "Detach vote", detached: "The vote was detached.",
      ...
      links: {
        ...
        removed: "Link removed.", removeConfirm: "Remove this link?",
      },
      participants: {
        author: "Thread author", distribution: "Contribution split", lastActive: "last seen: {{value}}",
        replies_one: "{{count}} reply", replies_other: "{{count}} replies",
        questions_one: "{{count}} question", questions_other: "{{count}} questions",
        documents_one: "{{count}} source", documents_other: "{{count}} sources",
        reactions_one: "{{count}} reaction", reactions_other: "{{count}} reactions",
        empty: "Nobody has spoken yet.",
        emptyHint: "People show up here after the first reply.",
      },
      insights: {
        timeline: "Thread rhythm", period: "Period: {{value}}", chartAria: "Thread activity chart",
        tableCaption: "Thread activity across time buckets",
        series: { replies: "Replies", questions: "Questions", documents: "Sources", milestones: "Milestones" },
        empty: "No data yet.", emptyHint: "The chart appears after the first activity.",
      },
      search: {
        label: "Search the thread", placeholder: "Search replies, sources and questions...",
        hint: "We search the whole thread, not just the visible page.",
        idle: "Type a phrase", idleHint: "Results cover replies, sources, schedule and questions.",
        tooShort: "Type at least two characters.",
        noResults: "No results", noResultsHint: "Try another phrase or a shorter word.",
        resultsCount_one: "{{count}} result", resultsCount_other: "{{count}} results",
      },
      tabs: {
        threads: "Topics",
        documents: "Documents",
