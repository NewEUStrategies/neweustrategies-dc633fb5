...
export const clubPl = {
  club: {
    ...
    hub: {
      ...
      identity: {
        ...
        cover: {
          ...
          position: {
            open: "Dostosuj kadrowanie",
            label: "Przesuń okładkę",
            title: "Kadrowanie okładki",
            hint: "Przesuń suwak, żeby wybrać fragment zdjęcia widoczny w nagłówku klubu. Podgląd pokazuje dokładnie tę samą proporcję, która jest używana na stronie.",
            top: "Góra zdjęcia",
            bottom: "Dół zdjęcia",
            slider: "Pionowa pozycja okładki",
            save: "Zapisz",
            cancel: "Anuluj",
            saved: "Kadrowanie zapisane",
            failed: "Nie udało się zapisać kadrowania",
          },
        },
      },
      composer: {
    ...
    // Przełącznik zwiniętej gałęzi. Liczba mówi, ILE treści chowa - inaczej
    // czytelnik nie wie, czy warto klikać.
    ...
    propose: {
      action: "Zgłoś klub",
      title: "Zgłoś nowy klub dyskusyjny",
      description:
        "Klub powstaje jako wersja robocza. Zostajesz jego prowadzącym, a zespół platformy decyduje o publikacji.",
      nameLabel: "Nazwa klubu (PL)",
      nameEnLabel: "Nazwa klubu (EN)",
      taglineLabel: "Krótki opis",
      descriptionLabel: "Opis klubu",
      policyAreaLabel: "Obszar tematyczny",
      motivationLabel: "Uzasadnienie zgłoszenia",
      submit: "Wyślij zgłoszenie",
      cancel: "Anuluj",
      done: "Zgłoszenie wysłane. Klub czeka na publikację.",
      nameRequired: "Nazwa klubu jest wymagana.",
      myTitle: "Moje zgłoszenia",
      status: {
        draft: "Oczekuje na publikację",
        active: "Opublikowany",
        archived: "Odrzucony lub zarchiwizowany",
      },
    },
    settings: {
      action: "Edytuj klub",
      title: "Dane klubu",
      description: "Zmiany widzą wszyscy członkowie klubu. Widoczność i status ustala platforma.",
      nameLabel: "Nazwa klubu (PL)",
      nameEnLabel: "Nazwa klubu (EN)",
      taglineLabel: "Krótki opis (PL)",
      taglineEnLabel: "Krótki opis (EN)",
      descriptionLabel: "Opis (PL)",
      descriptionEnLabel: "Opis (EN)",
      rulesLabel: "Zasady klubu (PL)",
      rulesEnLabel: "Zasady klubu (EN)",
      policyAreaLabel: "Obszar tematyczny",
      whoCanPostLabel: "Kto zakłada wątki",
      joinPolicyLabel: "Zasady dołączania",
      postPolicy: {
        members: "Każdy członek klubu",
        moderators: "Moderatorzy i prowadzący",
        staff_only: "Tylko zespół platformy",
      },
      joinPolicyOption: {
        open: "Dołączanie otwarte",
        request: "Na prośbę do zatwierdzenia",
        invite: "Tylko z zaproszenia",
      },
      submit: "Zapisz zmiany",
      cancel: "Anuluj",
      done: "Zmiany zapisane",
      noChanges: "Nie było czego zapisać.",
    },
  ...
  adminClubs: {
    ...
    create: {
      ...
      error: {
        ...
        quota: "Wysłałeś dziś maksymalną liczbę zgłoszeń klubów. Spróbuj ponownie za 24 godziny.",
...
export const clubEn = {
  club: {
      ...
      identity: {
        ...
        cover: {
          ...
          position: {
            ...
            label: "Move cover",
            title: "Cover framing",
            hint: "Move the slider to choose the part of the photo visible in the club header. The preview shows exactly the same 4:1 ratio used on the page.",
            top: "Top of the photo",
            bottom: "Bottom of the photo",
            slider: "Vertical cover position",
            save: "Save",
            cancel: "Cancel",
            saved: "Framing saved",
            failed: "Could not save framing",
          },
        },
      },
      composer: {
    ...
    propose: {
      action: "Propose a club",
      title: "Propose a new discussion club",
      description:
        "The club starts as a draft. You become its lead and the platform team decides on publication.",
      nameLabel: "Club name (PL)",
      nameEnLabel: "Club name (EN)",
      taglineLabel: "Short description",
      descriptionLabel: "Club description",
      policyAreaLabel: "Policy area",
      motivationLabel: "Why this club",
      submit: "Send proposal",
      cancel: "Cancel",
      done: "Proposal sent. The club is awaiting publication.",
      nameRequired: "The club name is required.",
      myTitle: "My proposals",
      status: {
        draft: "Awaiting publication",
        active: "Published",
        archived: "Rejected or archived",
      },
    },
    settings: {
      action: "Edit club",
      title: "Club details",
      description:
        "All club members see these changes. Visibility and status are set by the platform.",
      nameLabel: "Club name (PL)",
      nameEnLabel: "Club name (EN)",
      taglineLabel: "Short description (PL)",
      taglineEnLabel: "Short description (EN)",
      descriptionLabel: "Description (PL)",
      descriptionEnLabel: "Description (EN)",
      rulesLabel: "Club rules (PL)",
      rulesEnLabel: "Club rules (EN)",
      policyAreaLabel: "Policy area",
      whoCanPostLabel: "Who starts threads",
      joinPolicyLabel: "Joining rules",
      postPolicy: {
        members: "Any club member",
        moderators: "Moderators and leads",
        staff_only: "Platform team only",
      },
      joinPolicyOption: {
        open: "Open joining",
        request: "By request, subject to approval",
        invite: "Invitation only",
      },
      submit: "Save changes",
      cancel: "Cancel",
      done: "Changes saved",
      noChanges: "There was nothing to save.",
    },
  ...
  adminClubs: {
    ...
    create: {
      ...
      error: {
        ...
        quota: "You have sent the maximum number of club proposals today. Try again in 24 hours.",
