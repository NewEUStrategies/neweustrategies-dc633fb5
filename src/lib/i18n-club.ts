...
export const clubPl = {
  club: {
    ...
    // --- hub watku (A28) ---
    //
    // Osobny korzen od `club.workspace`, ktore opisuje przestrzen KLUBU.
    // To sa dwie rozne powierzchnie - wspolny korzen kazalby przy kazdym
    // kluczu zgadywac, o ktorej mowa.
    threadHub: {
      navLabel: "Sekcje watku",
      tabsLabel: "Sekcje watku",
      contextLabel: "Kontekst watku",
      ...
      cancel: "Anuluj",
      remove: "Usun",
      openLink: "Otworz odnosnik",
      inConversation_one: "{{count}} osoba w rozmowie",
      inConversation_few: "{{count}} osoby w rozmowie",
      inConversation_many: "{{count}} osob w rozmowie",
      inConversation_other: "{{count}} osob w rozmowie",

      stat: {
        replies_one: "odpowiedz",
        replies_few: "odpowiedzi",
        replies_many: "odpowiedzi",
        replies_other: "odpowiedzi",
        participants_one: "uczestnik",
        participants_few: "uczestnikow",
        participants_many: "uczestnikow",
        participants_other: "uczestnikow",
        documents_one: "zrodlo",
        documents_few: "zrodla",
        documents_many: "zrodel",
        documents_other: "zrodel",
        nextMilestone: "najblizszy termin",
      },
      ...
      questionSort: { top: "Najwazniejsze", new: "Najnowsze", unanswered: "Bez odpowiedzi" },
      section: {
        reply: "Wypowiedzi",
        document: "Dokumenty",
      ...
      linkDirection: { outgoing: "Ten watek wskazuje", incoming: "Wskazywany przez" },
      relation: {
        outgoing: {
      ...
      error: {
        forbidden: "Nie masz uprawnien do tej operacji w tym watku.",
        not_found: "Tej pozycji juz nie ma - odswiez widok.",
        url_required: "Ten rodzaj wymaga adresu. Notatka jest jedyna pozycja bez odnosnika.",
        anonymous_not_allowed: "Ten klub nie dopuszcza wpisow anonimowych.",
        answer_required: "Odpowiedz nie moze byc pusta.",
        self_link: "Watku nie da sie powiazac z samym soba.",
        poll_options: "Glosowanie potrzebuje od 2 do 8 wariantow.",
        auth_required: "Zaloguj sie, aby wykonac te akcje.",
        unknown: "Nie udalo sie zapisac. Sprobuj ponownie.",
      },
      documents: {
        primary: "Podstawowe",
        primaryHint: "Dokument, od ktorego zaczyna sie ta sprawa.",
        primaryLabel: "Oznacz jako dokument podstawowy",
        addedBy: "Wniosl(-osla): {{name}}",
        titleLabel: "Tytul",
        kindLabel: "Rodzaj",
        publishedLabel: "Data wydania",
        publishedHint: "Data dokumentu, nie data dodania do watku.",
        urlLabel: "Adres",
        sourceLabel: "Zrodlo",
        ...
        allKinds: "Wszystkie rodzaje",
        add: "Dodaj zrodlo",
        addFirst: "Dodaj pierwsze zrodlo",
        saved: "Zrodlo zapisane.",
        removed: "Zrodlo usuniete.",
        removeConfirm: "Usunac to zrodlo z watku?",
        empty: "Ten watek nie ma jeszcze zrodel.",
        emptyHint:
          "Dokumenty, zbiory danych i notatki zebrane tutaj zostaja z watkiem w archiwum - inaczej po pol roku zostaje sam link w cudzej wypowiedzi.",
        emptyReadonly: "Gdy uczestnicy wniosa materialy, pojawia sie w tym miejscu.",
      },
      schedule: {
        owner: "Prowadzi: {{name}}",
        ...
        kindLabel: "Rodzaj",
        statusLabel: "Status",
        allDay: "Caly dzien (bez godziny)",
        startsLabel: "Poczatek",
        endsLabel: "Koniec",
        rangeError: "Koniec nie moze wypadac przed poczatkiem.",
        locationLabel: "Miejsce",
        urlLabel: "Adres",
        descriptionLabel: "Opis",
        viewLabel: "Widok harmonogramu",
        view: { list: "Lista", calendar: "Kalendarz" },
        group: { today: "Dzis", upcoming: "Wkrotce", past: "Minione" },
        add: "Dodaj termin",
        addFirst: "Dodaj pierwszy termin",
        saved: "Termin zapisany.",
        removed: "Termin usuniety.",
        removeConfirm: "Usunac ten termin z harmonogramu?",
        empty: "Ten watek nie ma harmonogramu.",
        emptyHint:
          "Terminy konsultacji, spotkan i publikacji wpisane tutaj widac w liscie i w kalendarzu - to jeden zbior, nie dwa.",
        emptyReadonly: "Prowadzacy klubu moze dopisac terminy do tej dyskusji.",
      },
      calendar: {
        previous: "Poprzedni miesiac",
        next: "Nastepny miesiac",
        caption: "Harmonogram watku - {{month}}",
        more: "+{{count}} wiecej",
      },
      participants: {
        author: "Autor watku",
        distribution: "Rozklad wkladu",
        reactions: "reakcji",
        lastActive: "Ostatnio: {{date}}",
        replies_one: "{{count}} wypowiedz",
        ...
        questions_many: "{{count}} pytan",
        questions_other: "{{count}} pytan",
        documents_one: "{{count}} zrodlo",
        documents_few: "{{count}} zrodla",
        documents_many: "{{count}} zrodel",
        documents_other: "{{count}} zrodel",
        empty: "Nikt jeszcze nie zabral glosu w tym watku.",
        emptyHint: "Lista powstaje z wypowiedzi, pytan i wniesionych zrodel.",
      },
      questions: {
        vote: "Podbij waznosc pytania",
        ask: "Zadaj pytanie",
        asked: "Pytanie wyslane.",
        askLabel: "Twoje pytanie",
        askPlaceholder: "O co chcesz zapytac prowadzacego te dyskusje?",
        answer: "Odpowiedz",
        answeredBy: "Odpowiada: {{name}}",
        answerLabel: "Tresc odpowiedzi",
        answerCta: "Odpowiedz",
        editAnswer: "Popraw odpowiedz",
        publishAnswer: "Opublikuj odpowiedz",
        answerSaved: "Odpowiedz zapisana.",
        sortLabel: "Kolejnosc pytan",
        allAnswered: "Wszystkie pytania maja odpowiedz.",
        openCount_one: "{{count}} pytanie bez odpowiedzi",
        openCount_few: "{{count}} pytania bez odpowiedzi",
        openCount_many: "{{count}} pytan bez odpowiedzi",
        openCount_other: "{{count}} pytan bez odpowiedzi",
        empty: "Nikt jeszcze nie zadal pytania.",
        emptyHint:
          "Pytanie ma adresata i stan: widac, na ktore nikt nie odpowiedzial. W drzewie wypowiedzi ta informacja ginie.",
        emptyReadonly: "Pytania do tej dyskusji pojawia sie w tym miejscu.",
      },
      polls: {
        create: "Nowe glosowanie",
        created: "Glosowanie utworzone.",
        ...
        removeOption: "Usun wariant",
        open: "Otwarte",
        closed: "Zamkniete",
        detach: "Odepnij",
        detached: "Glosowanie odpiete od watku.",
        detachConfirm: "Odpiac to glosowanie od watku? Oddane glosy zostana zachowane.",
        empty: "W tym watku nie ma glosowan.",
        emptyHint:
          "Glosowanie rozstrzyga sprawe, o ktorej dyskusja juz sie wypowiedziala - rozklad glosow widac dopiero po oddaniu wlasnego.",
        emptyReadonly: "Prowadzacy klubu moze otworzyc glosowanie w tej dyskusji.",
      },
      links: {
        empty: "Ten watek nie ma powiazan z innymi.",
        emptyHint:
          "Powiazanie mowi, JAK dwa watki sie maja do siebie - ze jeden kontynuuje drugi albo mu przeczy. Zaklada je prowadzacy klubu.",
        removed: "Powiazanie usuniete.",
        removeConfirm: "Usunac to powiazanie?",
      },
      insights: {
        timeline: "Aktywnosc w czasie",
        period: "Okres",
        tableCaption: "Aktywnosc watku w podziale na okresy",
        chartAria: "Wykres aktywnosci: {{total}} zdarzen w okresie {{range}}",
        series: {
          replies: "Wypowiedzi",
          questions: "Pytania",
          documents: "Zrodla",
        ...
        empty: "Za malo danych, zeby cos pokazac.",
        emptyHint: "Wykres pojawi sie po pierwszych wypowiedziach, pytaniach albo zrodlach.",
      },
      search: {
        label: "Szukaj w tym watku",
        placeholder: "Fraza z wypowiedzi, zrodla, terminu albo pytania...",
        hint: "Szukamy w wypowiedziach, zrodlach, harmonogramie i pytaniach tego watku - nie po calej platformie.",
        tooShort: "Wpisz co najmniej dwa znaki.",
        idle: "Znajdz ustalenie bez czytania calosci",
        idleHint:
          "Po trzech miesiacach dyskusji to jest roznica miedzy odnalezieniem konkretu a przeczytaniem dwustu wypowiedzi od nowa.",
        noResults: 'Brak wynikow dla "{{query}}".',
        noResultsHint: "Sprobuj innego slowa - szukamy po odmianie, ale nie po synonimach.",
        resultsCount_one: "Znaleziono {{count}} wynik",
        resultsCount_few: "Znaleziono {{count}} wyniki",
        resultsCount_many: "Znaleziono {{count}} wynikow",
        resultsCount_other: "Znaleziono {{count}} wynikow",
      },
    },
...
export const clubEn = {
  club: {
    ...
    threadHub: {
      ...
      remove: "Remove",
      openLink: "Open link",
      inConversation_one: "{{count}} person in the conversation",
      inConversation_other: "{{count}} people in the conversation",
      ...
      stat: {
        ...
        documents_one: "source",
        documents_other: "sources",
        nextMilestone: "next date",
      },
      ...
      questionSort: { top: "Most wanted", new: "Newest", unanswered: "Unanswered" },
      section: {
        reply: "Replies",
        document: "Documents",
        milestone: "Schedule",
      ...
      linkDirection: { outgoing: "This thread points to", incoming: "Pointed to by" },
      relation: {
        outgoing: {
          continues: "Continues",
      ...
      schedule: {
        ...
        group: { today: "Today", upcoming: "Coming up", past: "Past" },
        add: "Add date",
