...
const careersPl = {
  careers: {
    ...
    roles: {
      ...
      showingShort: "{{total}} ról",
      statusLabel: "Status rekrutacji",
    ...
    form: {
      ...
      next: "Dalej",
      fitOptional:
        "Wszystkie pola w tym kroku są wymagane - dzięki nim kierujemy zgłoszenie do właściwej osoby.",
      firstName: "Imię",
      lastName: "Nazwisko",
      email: "Adres e-mail",
      phone: "Telefon",
      linkedin: "Profil LinkedIn lub portfolio (opcjonalnie)",
      cv: "CV (wymagane)",
      cvHint: "Wgraj plik (PDF, DOC, DOCX, do 5 MB) albo wklej link do CV.",
      cvUpload: "Wgraj plik CV",
      cvChange: "Zmień plik",
      cvRemove: "Usuń plik",
      cvUrl: "Link do CV (np. Dysk Google, portfolio)",
      cvUploading: "Wysyłamy plik...",
      cvOr: "albo",
      department: "Dział",
      ...
      message: "Dlaczego Ty i co chcesz u nas robić? (opcjonalnie)",
      messagePlaceholder:
      ...
      sending: "Wysyłanie...",
      errors: {
        summary: "Popraw {{count}} pole, aby wysłać zgłoszenie.",
        summary_plural: "Popraw {{count}} pola/pól, aby wysłać zgłoszenie.",
        firstNameRequired: "Podaj imię.",
        firstNameLong: "Imię może mieć maksymalnie 60 znaków.",
        firstNameInvalid: "Imię może zawierać tylko litery, spacje i myślnik.",
        lastNameRequired: "Podaj nazwisko.",
        lastNameLong: "Nazwisko może mieć maksymalnie 60 znaków.",
        lastNameInvalid: "Nazwisko może zawierać tylko litery, spacje i myślnik.",
        ...
        phoneRequired: "Podaj numer telefonu - kontaktujemy się także telefonicznie.",
        phoneInvalid: "Podaj poprawny numer telefonu, np. +48 600 100 200.",
        linkedinLong: "Link jest za długi.",
        linkedinInvalid: "Podaj poprawny adres, np. linkedin.com/in/twoj-profil.",
        departmentRequired: "Wybierz dział.",
        roleRequired: "Wybierz rolę albo zgłoszenie spontaniczne.",
        seniorityRequired: "Wybierz poziom doświadczenia.",
        startRequired: "Wybierz możliwy termin startu.",
        messageLong: "Wiadomość może mieć maksymalnie {{max}} znaków.",
        cvRequired: "Dołącz CV - wgraj plik albo wklej link.",
        cvUrlInvalid: "Podaj poprawny link do CV, np. drive.google.com/...",
        cvUrlLong: "Link do CV jest za długi.",
        cvTooLarge: "Plik jest za duży - maksymalnie 5 MB.",
        cvType: "Dozwolone formaty: PDF, DOC, DOCX.",
        cvUploadFailed: "Nie udało się wgrać pliku. Spróbuj ponownie albo wklej link.",
        consentRequired: "Zaznacz zgodę na przetwarzanie danych.",
      },
...
const careersEn = {
  careers: {
    ...
    form: {
      ...
      next: "Next",
      fitOptional:
        "All fields in this step are required - they let us route your application to the right person.",
      firstName: "First name",
      lastName: "Last name",
      email: "Email address",
      phone: "Phone",
      linkedin: "LinkedIn profile or portfolio (optional)",
      cv: "CV (required)",
      cvHint: "Upload a file (PDF, DOC, DOCX, up to 5 MB) or paste a link to your CV.",
      cvUpload: "Upload CV file",
      cvChange: "Change file",
      cvRemove: "Remove file",
      cvUrl: "Link to your CV (e.g. Google Drive, portfolio)",
      cvUploading: "Uploading file...",
      cvOr: "or",
      ...
      message: "Why you, and what do you want to work on? (optional)",
      messagePlaceholder:
      ...
      sending: "Sending...",
      errors: {
        summary: "Fix {{count}} field to send your application.",
        summary_plural: "Fix {{count}} fields to send your application.",
        firstNameRequired: "Enter your first name.",
        firstNameLong: "First name can have up to 60 characters.",
        firstNameInvalid: "First name may contain letters, spaces and hyphens only.",
        lastNameRequired: "Enter your last name.",
        lastNameLong: "Last name can have up to 60 characters.",
        lastNameInvalid: "Last name may contain letters, spaces and hyphens only.",
        emailRequired: "Enter your email address.",
        emailLong: "The email address is too long.",
        emailInvalid: "Enter a valid email address, e.g. name@company.com.",
        phoneRequired: "Enter your phone number - we also call candidates.",
        phoneInvalid: "Enter a valid phone number, e.g. +48 600 100 200.",
        linkedinLong: "The link is too long.",
        linkedinInvalid: "Enter a valid address, e.g. linkedin.com/in/your-profile.",
        departmentRequired: "Choose a department.",
        roleRequired: "Choose a role or a spontaneous application.",
        seniorityRequired: "Choose your seniority level.",
        startRequired: "Choose your possible start date.",
        messageLong: "The message can have up to {{max}} characters.",
        cvRequired: "Attach your CV - upload a file or paste a link.",
        cvUrlInvalid: "Enter a valid CV link, e.g. drive.google.com/...",
        cvUrlLong: "The CV link is too long.",
        cvTooLarge: "The file is too large - 5 MB maximum.",
        cvType: "Allowed formats: PDF, DOC, DOCX.",
        cvUploadFailed: "We could not upload the file. Try again or paste a link.",
        consentRequired: "Please accept the data processing consent.",
      },
      charsLeft: "{{count}} characters left",
      sendingStatus: "Sending your application - please keep this page open.",
