  ...
  careers: {
    ...
    form: {
      ...
      errors: {
        ...
        linkedinRequired: "Podaj link do profilu LinkedIn lub portfolio.",
        ...
        messageRequired: "Napisz kilka zdań o sobie.",
        messageShort: "Napisz co najmniej {{min}} znaków - to pole zastępuje CV.",
  ...
  careers: {
    ...
    form: {
      ...
      errors: {
        ...
        linkedinRequired: "Add a link to your LinkedIn profile or portfolio.",
        ...
        messageRequired: "Write a few sentences about yourself.",
        messageShort: "Write at least {{min}} characters - this field replaces a CV.",
