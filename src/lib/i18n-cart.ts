...
const pl = {
  ...
  eventMe: {
    ...
    organization: {
      ...
      searchFailed: "Nie udało się wyszukać organizacji. Spróbuj ponownie za chwilę.",
      listAria: "Lista podpowiedzi organizacji",
      dialogTitle: "Nowa organizacja",
      dialogHint:
        "Dodaj instytucję, jeśli nie ma jej jeszcze na liście. Dane zobaczą organizatorzy wydarzenia.",
      ...
      logoHint:
        "Przeciągnij plik lub wybierz z dysku. Najlepiej PNG/SVG na przezroczystym tle, do 5 MB.",
    ...
    publicPreview: {
      ...
      actionsSelf:
        "Tak wygląda pasek kontaktu, który zobaczą inni uczestnicy - na własnej wizytówce jest wyłączony.",
      actionsSignIn:
        "Zaloguj się, aby dodać do kontaktów, napisać wiadomość lub umówić spotkanie 1-1.",
    ...
    networkingHint: "Ustaw swoją dostępność, widoczność w katalogu i zarządzaj zaproszeniami 1-1.",
...
const en: typeof pl = {
  ...
  eventMe: {
    ...
    organization: {
      ...
      searchFailed: "The organisation search failed. Try again in a moment.",
      listAria: "Organisation suggestions",
      dialogTitle: "New organisation",
      dialogHint:
        "Add the institution if it is not on the list yet. Event organisers will see these details.",
      ...
      logoHint:
        "Drag a file here or pick one from disk. PNG/SVG on a transparent background, up to 5 MB.",
    ...
    publicPreview: {
      ...
      actionsSelf:
        "This is the contact bar other attendees will see - it is disabled on your own card.",
