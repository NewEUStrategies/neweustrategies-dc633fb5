...
const pl = {
  ...
  search: {
    ...
    voice_stop: "Zatrzymaj dyktowanie",
    popular: "Popularne",
    ...
    adv: {
      ...
      syntax_or: "dowolne ze słów (operator wielkimi literami)",
      syntax_not: "wyklucz (to samo co -)",
    ...
    widget: {
      ...
      no_results_hint: "Sprawdź pisownię lub użyj innego słowa kluczowego.",
...
const en = {
  ...
  search: {
    ...
    adv: {
      ...
      syntax_or: "either word (uppercase operator)",
      syntax_not: "exclude (same as -)",
      chip_match: "Match",
      chip_scope: "Scope",
    },
    people: {
    ...
    widget: {
      ...
      no_results_hint: "Check spelling or try a different keyword.",
