...
import { networkPl, networkEn } from "@/lib/i18n-network";
...
const PL = networkPl as unknown as Record<string, unknown>;
const EN = networkEn as unknown as Record<string, unknown>;

// Same rule as the chat bundle parity test: Polish legitimately has more
...
describe("i18n network bundle (pl/en)", () => {
