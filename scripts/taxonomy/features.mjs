...
export const FEATURES_3 = [
  ...
  },
  {
    ...
    patterns: [
      /^src\/lib\/builder\/(animatedHeadingVariants|animatedHeadingLinks|sectionLabelVariants|coverOverlayCard|promoCard|travelRouteCard|teamGrid|worldMapContent|speakerRow|clubHub|socialBrand)\.tsx?$/,
    ],
  },
  {
