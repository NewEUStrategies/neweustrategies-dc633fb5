...
Liczby „przed" pochodzą z audytu 2026-08-18. Liczby „po" - z pomiarów przy każdym commicie
(`vitest run --coverage`, provider v8, konfiguracja repo bez zmian).
...
**Testy:** 33 pliki testowe (nowe i rozszerzone), **980 przypadków, 2 079 asercji**,
gęstość **2,12 asercji na przypadek** (wymagane ≥ 2).
