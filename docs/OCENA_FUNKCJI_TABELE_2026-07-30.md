...
*Dokument towarzyszy `AUDYT_BRUTALNY_REWIZJA_ZALOZEN_2026-07-30.md` (rewizja werdyktu 8,0→7,0) i mapuje
oceny funkcji na strukturę konkurencyjną z `OCENA_FUNKCJI_KONKURENCI_2026-07-24.md`. Oceny konkurentów =
stan wiedzy do poł. 2026; „b/d" = brak danych z zewnątrz, nie brak funkcji.*
