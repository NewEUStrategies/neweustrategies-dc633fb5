...
| Pełna suita | 1 293 pliki, 29 312 testów zielonych, 24 `it.fails`, 50 pominiętych |
...
Całe `src/` (pełna suita): **62,03 / 56,37 / 58,31 / 62,93** (przed zadaniem, wg wpisu
...
| Sprawdzenie | Wynik |
| --- | --- |
| `npx vitest run` | 1 293 pliki, 29 312 testów zielonych, 24 `it.fails` (oczekiwane), 50 pominiętych |
