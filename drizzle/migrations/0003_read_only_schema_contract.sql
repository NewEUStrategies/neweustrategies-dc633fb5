...
-- Inspect metadata in bounded batches without invoking application functions.
-- Like missing_migration_versions, return only a subset of caller-supplied names.
