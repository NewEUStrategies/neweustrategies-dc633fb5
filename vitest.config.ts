...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      // pierwszym nieudanym teście - bez tej flagi jeden czerwony test zabiera cały
      // pomiar i praca nad pokryciem toczy się po omacku (dokładnie to unieważniło
      // pomiar w audycie 2026-08-18: MODUŁ 3 raportowano z zaniżonych liczb, bo
      // powierzchnie panelowe nie doszły nawet do fazy raportu).
